    ...
    @foreach($asets as $asset)
      ...
      <div class="card">
        ...
        <div class="meta no-print">
          <div class="name">{{ $asset->nama }}</div>
          <div class="row"><div class="label">Lokasi:</div><div class="value">{{ $asset->lokasi }}</div></div>
          <div class="row"><div class="label">Tim:</div><div class="value">{{ optional($asset->team)->nama ?? '-' }}</div></div>
          <div class="row"><div class="label">Status:</div><div class="value">{{ $asset->status }}</div></div>
        </div>
      </div>
    @endforeach
  </div>
